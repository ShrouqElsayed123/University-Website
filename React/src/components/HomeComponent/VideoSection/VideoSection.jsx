...
export default function VideoSection({ content }) {
  ...
  return (
    <section className=" bg-gray-50 transition-colors duration-300 my-home-section-margin p-home-section-padding"
      data-aos="fade-right"
    >
          ...
          <div className="relative animate-fade-in-left animation-delay-300">
            ...
            >
              {isPlaying ? (
                ...
                <>
                  <img src={coverImg} alt="Video cover" className="w-full h-auto object-cover" />
